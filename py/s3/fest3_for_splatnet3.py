...
with open('C:/Users/User/Downloads/eufestc.json', 'r', encoding="utf8") as file_in:
    data = json.load(file_in)

#data = data['data']['fest']['teams'][2]['result']['rankingHolders']['edges'] #0,1,2 for alpha,bravo,charlie teams #for page 1
data = data['node']['result']['rankingHolders']['edges'] #0,1,2 for alpha,bravo,charlie teams #for page 2,3,4
...
with open('C:/Users/User/Downloads/eufestc_parsed.txt', 'w', encoding="utf8") as file_out:
    ...
    for player in data:
        ...
        file_out.write("|-\n")
        file_out.write("| " +  str(rank) + " || " + name + " || " + str(power)  +
