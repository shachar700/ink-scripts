...
with open('C:/Users/User/Downloads/usfest.json', 'r', encoding="utf8") as file_in:
    data = json.load(file_in)

data = data['data']['fest']['teams'][0]['result']['rankingHolders']['nodes'] #0,1,2 for alpha,bravo,charlie teams
...
with open('C:/Users/User/Downloads/usfest_parsed.txt', 'w', encoding="utf8") as file_out:
