...
with open('C:/Users/User/PycharmProjects/pythonProjectInkipedia/jpfest.json', 'r', encoding="utf8") as file_in:
...
with open('C:/Users/User/PycharmProjects/pythonProjectInkipedia/weapons.json', 'r', encoding="utf8") as weapons_json_file:
    data_weapons = json.load(weapons_json_file)

data_dict_adj = {}
with open('C:/Users/User/PycharmProjects/pythonProjectInkipedia/titles-adj.txt', 'r', encoding="utf8") as titles_adj:
    for line in titles_adj:
        k, v = line.strip().split(':')
        data_dict_adj[k.strip()] = v.strip()

data_dict_subj = {}
with open('C:/Users/User/PycharmProjects/pythonProjectInkipedia/titles-sbj.txt', 'r', encoding="utf8") as titles_subj:
...
with open('C:/Users/User/PycharmProjects/pythonProjectInkipedia/jpfest_parsed.txt', 'w', encoding="utf8") as file_out:
